...
struct PublisherTest
{
    ...
    explicit PublisherTest(FilterOrchestratorConfig c)
      : config(c)
    {
    }
  ...
  void init(size_t run_number){
    ...
    auto init_sender1 = dunedaq::get_iom_sender<dunedaq::datafilter::Handshake>("trdispatcher0");
    auto init_receiver1 = dunedaq::get_iom_receiver<dunedaq::datafilter::Handshake>("trdispatcher1");
